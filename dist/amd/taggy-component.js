define(['exports', './taggy', 'aurelia-framework', 'aurelia-event-aggregator'], function (exports, _taggy, _aureliaFramework, _aureliaEventAggregator) {
    ...
    var TaggyComponent = exports.TaggyComponent = (_class = function () {
        ...
        TaggyComponent.prototype._initTaggy = function _initTaggy() {
            ...
            if (typeof this.initialValues !== "undefined" && this.initialValues !== null) {
                this.initialValues.forEach(function (it) {
                    return _this.taggyElement.addItem(it);
                });
            }
        ...
        enumerable: true,
        initializer: null
    }), _descriptor4 = _applyDecoratedDescriptor(_class.prototype, 'initialValues', [_aureliaFramework.bindable], {
        enumerable: true,
        initializer: null
        ...
        enumerable: true,
        initializer: null
    }), _descriptor12 = _applyDecoratedDescriptor(_class.prototype, 'parseValue', [_aureliaFramework.bindable], {
        enumerable: true,
        initializer: null
    }), _descriptor13 = _applyDecoratedDescriptor(_class.prototype, 'parseText', [_aureliaFramework.bindable], {
        enumerable: true,
        initializer: null
